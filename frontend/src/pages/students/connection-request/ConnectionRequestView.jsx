    ...
    <div className="connection-request-view-page">
      ...
      <div className="request-view-container">
        <div className="request-header">
          <button className="back-btn" onClick={() => window.history.length > 1 ? navigate(-1) : navigate('/home')}>
        ...
        {request.status === 'pending' && (
          <div className="request-actions">
            <button className="decline-btn" disabled={actionLoading} onClick={async () => {
              try {
            ...
            <button className="accept-btn" disabled={actionLoading} onClick={async () => {
              try {
                setActionLoading(true);
