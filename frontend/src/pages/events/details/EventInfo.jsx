            ...
            <aside className="event-sidebar">
              ...
              <div className="action-card share-card">
                ...
                <div className="share-buttons">
                  <button className="share-btn" title="Share on Twitter" onClick={() => {
                    const url = window.location.href;
                    const text = encodeURIComponent(`Check out "${event.eventName}" on MentorLink!`);
                  ...
                  <button className="share-btn" title="Share on Facebook" onClick={() => {
                  ...
                  <button className="share-btn" title="Share on LinkedIn" onClick={() => {
                    const url = encodeURIComponent(window.location.href);
